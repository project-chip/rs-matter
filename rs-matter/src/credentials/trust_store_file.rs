...
//! File-backed PAA trust store (`std` only).
//!
//! Loads PAA certificates from a directory of `.der` files at runtime.

use super::trust_store::{extract_skid, AttestationTrustStore, KeyId, MAX_PAA_CERT_DER_LEN};
...
///
/// ```ignore
/// use rs_matter::credentials::trust_store_file::FileAttestationTrustStore;
///
