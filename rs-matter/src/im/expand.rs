...
//!
//! Expands (potentially wildcard) Read, Write and Invoke request paths into
//! concrete attribute/command details against the node metadata, applying
//! accessor (ACL) and fabric/dataver filtering. Consumed by the IM engine in
//! [`crate::im`].
