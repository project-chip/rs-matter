...
mod tests {
    ...
    fn test_verify_msg_success() {
        ...
        let key = unwrap!(crypto.pub_key(test_vectors::PUB_KEY1));
        assert_eq!(
    ...
    mod test_vectors {
        use crate::crypto::{CanonPkcPublicKey, CanonPkcSignature};

        pub const PUB_KEY1: &CanonPkcPublicKey = &[
        ...
        pub const SIGNATURE1: &CanonPkcSignature = &[
