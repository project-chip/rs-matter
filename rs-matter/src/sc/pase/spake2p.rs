...
const MATTER_N_BIN: CanonEcPointRef = CanonEcPointRef::new_from_slice(&[
...
impl<'a, C: Crypto> CryptoSpake2<'a, C> {
    ...
    pub fn set_w0_from_w0s(&mut self, w0s: CanonUint320Ref<'_>) -> Result<(), Error> {
        ...
        const OPERAND: CanonEcScalarRef = CanonEcScalarRef::new_from_slice(&[
...
mod tests {
    ...
    pub const RFC_T: [RFCTestVector; 4] = [
        RFCTestVector {
            w0: CanonEcScalarRef::new_from_slice(&[
            ...
            w1: CanonEcScalarRef::new_from_slice(&[
            ...
            x: CanonEcScalarRef::new_from_slice(&[
            ...
            X: CanonEcPointRef::new_from_slice(&[
            ...
            y: CanonEcScalarRef::new_from_slice(&[
            ...
            Y: CanonEcPointRef::new_from_slice(&[
            ...
            Z: CanonEcPointRef::new_from_slice(&[
            ...
            V: CanonEcPointRef::new_from_slice(&[
            ...
            L: CanonEcPointRef::new_from_slice(&[
