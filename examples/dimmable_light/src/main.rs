...
use rs_matter::data_model::device_types::DEV_TYPE_DIMMABLE_LIGHT;
use rs_matter::data_model::objects::*;
use rs_matter::data_model::root_endpoint;
use rs_matter::data_model::system_model::descriptor;
use rs_matter::data_model::{cluster_level_control, cluster_on_off};
...
const NODE: Node<'static> = Node {
    ...
    endpoints: &[
        ...
        Endpoint {
            id: 1,
            device_type: DEV_TYPE_DIMMABLE_LIGHT,
            clusters: &[
                descriptor::CLUSTER,
                cluster_on_off::CLUSTER,
                cluster_level_control::CLUSTER,
            ],
        },
    ],
};
...
fn handler<'a>(matter: &'a Matter<'a>) -> impl Metadata + NonBlockingHandler + 'a {
    (
        ...
        root_endpoint::handler(0, matter)
            ...
            .chain(
                1,
                cluster_level_control::ID,
                cluster_level_control::LevelControlClusterBuilder::default()
                    .data_ver(*matter.borrow())
                    .build(),
            ),
    )
}
